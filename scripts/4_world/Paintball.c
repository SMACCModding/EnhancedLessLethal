...
class ELL_Ammo_Paintball: Ammunition_Base {};

class ELL_PaintballGun_ColorBase: Ruger1022_Base {
...
modded class PluginRecipesManager {
    override void RegisterRecipies()
	{
		...
		RegisterRecipe(new ELL_FillPaintballDrum);
    };
};
class ELL_FillPaintballDrum extends RecipeBase {
	override void Init()
	{
		...
		InsertIngredient(0,"ELL_Ammo_Paintball");
		...
		//ingredient 2
		InsertIngredient(1,"ELL_Mag_PaintballDrum");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ELL_Mag_PaintballDrum");//add results here
